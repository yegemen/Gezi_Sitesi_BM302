...
<div class="left">
    ...
    $ara=$_POST["ara"];
    if (!empty($baglan)) {
        $v=$baglan->prepare("select * from gkonular inner join gkatagoriler on gkatagoriler.katagori_id=gkonular.konu_katagori where konu_baslik like ?");
        $v->execute(array('%'.$ara.'%'));
       ...
       if ($c){
           ...
           echo '<div class="error-search"> aramanıza ait konu bulunamadı üzgünüz</div>';
       }
